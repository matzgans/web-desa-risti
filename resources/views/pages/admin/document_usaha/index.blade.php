        ...
        <div class="max-w-full px-3 sm:px-6 lg:px-8">
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <div class="mb-2 flex flex-col items-center sm:flex-row">
                    <form class="mb-2 w-full sm:mb-0 sm:me-2" action="{{ route('admin.document.usaha.index') }}"
                        method="GET">
                    ...
                    <table
                        ...
                        <thead class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th class="border border-gray-300 px-6 py-3" scope="col">Nama Usaha</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Alamat Usaha</th>
                        ...
                        <tbody>
                            @forelse ($documents as $document)
                                <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                                    ...
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['business_name'] }}</td>
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['address_business'] }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['address'] }}
                                    </td>
                                    </td>
                                    ...
                                    <td class="border border-gray-300 px-6 py-4">
                                        <div class="flex items-center">
                                            <a href="{{ route('admin.document.usaha.edit', $document['id']) }}">
