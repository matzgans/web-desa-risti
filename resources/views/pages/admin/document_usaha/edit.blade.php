                ...
                <form method="POST" action="{{ route('admin.document.usaha.update', ['usaha' => $id]) }}">
                    ...
                    <div class="hidden">
                        ...
                        <input
                            ...
                            id="type" name="type" type="text" value="ket_usaha" placeholder="" required />
                    </div>
                    <div class="mb-6 grid gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input
                                class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                                id="pekerjaan" name="address_business" type="text"
                                value="{{ $data['address_business'] }}" placeholder="Jl. Jakarta" required />
                        </div>
                        <div>
                            <label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"
                                for="religion">Agama :
