    ...
    <div class="pt-4">
        <div class="max-w-7xl px-0 sm:px-6 lg:px-8">
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <form class="mx-auto max-w-full" action="{{ route('admin.farm.store') }}" method="POST"
                    ...
                    <div class="grid w-full grid-cols-3 gap-4">
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="cow_count" name="cow_count" type="number" value="{{ old('cow_count') }}"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="cow_owner" name="cow_owner" type="number" value="{{ old('cow_owner') }}"
                                    placeholder="0" required />
                                @error('cow_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('goat_count') }}" placeholder="0" required />
                                @error('goat_count')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('goat_owner') }}" placeholder="0" required />
                                @error('goat_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="dog_count" name="dog_count" type="number" value="{{ old('dog_count') }}"
                                    placeholder="0" required />
                                @error('dog_count')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input
                                    class="col-span-2 block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="dog_owner" name="dog_owner" type="number" value="{{ old('dog_owner') }}"
                                    placeholder="0" required />
                                @error('dog_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="cat_count" name="cat_count" type="number" value="{{ old('cat_count') }}"
                                    placeholder="0" required />
                                @error('cat_count')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input
                                    class="col-span-2 block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="cat_owner" name="cat_owner" type="number" value="{{ old('cat_owner') }}"
                                    placeholder="0" required />
                                @error('cat_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('chicken_count') }}" placeholder="0" required />
                                @error('chicken_count')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('chicken_owner') }}" placeholder="0" required />
                                @error('chicken_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('duck_count') }}" placeholder="0" required />
                                @error('duck_count')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('duck_owner') }}" placeholder="0" required />
                                @error('duck_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
