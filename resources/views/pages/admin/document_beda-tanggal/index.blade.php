    ...
    <div class="pt-4">
        <div class="max-w-full px-3 sm:px-6 lg:px-8">
            <div class="mb-3 flex justify-between rounded-lg bg-secondary p-4 text-white shadow-lg">
                <h2>Data Surat Keterangan Beda Tanggal Lahir</h2>
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <div class="mb-2 flex flex-col items-center sm:flex-row">
                    <form class="mb-2 w-full sm:mb-0 sm:me-2"
                        action="{{ route('admin.document.beda-tanggal.index') }}" method="GET">
                    ...
                    <table
                        ...
                        <thead class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th class="border border-gray-300 px-6 py-3" scope="col">Tanggal Lahir Benar</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Tanggal Lahir Salah</th>
                        ...
                        <tbody>
                            @forelse ($documents as $document)
                                <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                                    ...
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['wrong_birth'] }}</td>
                                    ...
                                    <td class="border border-gray-300 px-6 py-4">
                                        ...
                                        <div class="flex items-center">
                                            <a
                                                href="{{ route('admin.document.beda-tanggal.edit', $document['id']) }}">
