                    ...
                    <table
                        ...
                        <thead class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th class="border border-gray-300 px-6 py-3" scope="col">Nama Orang Meninggal</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Jam, Hari & Tanggal
                                    Meninggal
                                </th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Sebab Meninggal
                                </th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Tempat Meninggal</th>
                                ...
                                <th class="border border-gray-300 px-6 py-3" scope="col">Nama Ibu</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Pekerjaan Ibu</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Alamat Ibu</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Nama Ayah</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Pekerjaan Ayah</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Alamat Ayah</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Nama Saksi I</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Tempat/Tanggal Lahir Saksi
                                    I:</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Pekerjaan Saksi
                                    I:</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Alamat Saksi
                                    I:</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Nama Saksi II</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Tempat/Tanggal Lahir Saksi
                                    II:</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Pekerjaan Saksi
                                    II:</th>
                        ...
                        <tbody>
                            @forelse ($documents as $document)
                                <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                                    ...
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ ucfirst($document['day_death']) }},
                                        {{ ucfirst($document['date_death']) }} Jam :
                                        {{ ucfirst($document['time_death']) }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['cause_death'] }}</td>
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['place_death'] }}</td>
                                    ...
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['married_status'] }}
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['name_ibu'] }}
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['job_ibu'] }}
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['address_ibu'] }}
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['name_ayah'] }}
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['job_ayah'] }}
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['address_ayah'] }}
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['name_saksi1'] }}
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['birth_saksi1'] }}
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['job_saksi1'] }}
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['address_saksi1'] }}
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['name_saksi2'] }}
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['birth_saksi2'] }}
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['job_saksi2'] }}
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['address_saksi2'] }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                            ...
                            @empty
                                <tr>
                                    <td class="border border-gray-300 px-6 py-4 text-center" colspan="8">Tidak ada
                                        data
                                    </td>
                                </tr>
                            @endforelse
