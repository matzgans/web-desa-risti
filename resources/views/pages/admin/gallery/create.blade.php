    ...
    <div class="pt-4">
        <div class="max-w-7xl px-0 sm:px-6 lg:px-8">
            <div class="mb-3 flex justify-between rounded-lg bg-secondary p-4 text-white shadow-lg">
                ...
                <a class="flex items-center hover:underline" href="{{ route('admin.gallery.index') }}">
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <form class="mx-auto max-w-full" action="{{ route('admin.gallery.store') }}" method="POST"
                    ...
                    <div class="grid w-full grid-cols-1 gap-2">
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea
                                ...
                                id="message" name="description" value="{{ old('description') }}" rows="4"
                                placeholder="Tuliskan Caption Gambar"></textarea>
