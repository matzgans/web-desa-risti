        ...
        <div class="max-w-7xl px-0 sm:px-6 lg:px-8">
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <form class="mx-auto max-w-full"
                    action="{{ route('admin.gallery.update', ['gallery' => $gallery->id]) }}" method="POST"
                    ...
                    <div class="grid w-full grid-cols-1 gap-2">
                        <div class="col-span-2">
                            ...
                            <input
                                ...
                                id="title" name="title" type="text" value="{{ old('title', $gallery->title) }}"
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea
                                ...
                                id="message" name="description" value="{{ old('description', $gallery->description) }}" rows="4"
                                placeholder="Tuliskan Kontent Yang Ingin Anda Tulis">{{ $gallery->description }}</textarea>
                        ...
                        <div class="col-span-2 mb-6 grid grid-cols-1 gap-4">
                            <div>
                                <label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"
                            ...
                            <div class="relative h-64 w-full rounded-lg border-2 border-gray-300">
                                <img class="h-60 w-full rounded-lg object-contain" id="preview"
                                    src="{{ asset('gallery/thumb/' . $gallery->image) }}" alt="Image preview" />
                            </div>
                        </div>
                    </div>
