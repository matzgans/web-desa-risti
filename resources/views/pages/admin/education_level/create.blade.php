    ...
    <div class="pt-4">
        <div class="max-w-7xl px-0 sm:px-6 lg:px-8">
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <form class="mx-auto max-w-full" action="{{ route('admin.education.level.store') }}" method="POST"
                    ...
                    <div class="grid w-full grid-cols-3 gap-4">
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="belum_l" name="belum_l" type="number" value="{{ old('belum_l') }}"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="belum_p" name="belum_p" type="number" value="{{ old('belum_p') }}"
                                    placeholder="0" required />
                                @error('belum_p')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="sd_l" name="sd_l" type="number" value="{{ old('sd_l') }}"
                                    placeholder="0" required />
                                @error('sd_l')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input
                                    class="col-span-2 block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="sd_p" name="sd_p" type="number" value="{{ old('sd_p') }}"
                                    placeholder="0" required />
                                @error('sd_p')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="smp_l" name="smp_l" type="number" value="{{ old('smp_l') }}"
                                    placeholder="0" required />
                                @error('smp_l')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input
                                    class="col-span-2 block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="smp_p" name="smp_p" type="number" value="{{ old('smp_p') }}"
                                    placeholder="0" required />
                                @error('smp_p')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-span-3 grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="sma_l" name="sma_l" type="number" value="{{ old('sma_l') }}"
                                    placeholder="0" required />
                                @error('sma_l')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input
                                    class="col-span-2 block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="sma_p" name="sma_p" type="number" value="{{ old('sma_p') }}"
                                    placeholder="0" required />
                                @error('sma_p')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-span-3 grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="pt_l" name="pt_l" type="number" value="{{ old('pt_l') }}"
                                    placeholder="0" required />
                                @error('pt_l')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input
                                    class="col-span-2 block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="pt_p" name="pt_p" type="number" value="{{ old('pt_p') }}"
                                    placeholder="0" required />
                                @error('pt_p')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
