    ...
    <div class="pt-4">
        <div class="max-w-7xl px-0 sm:px-6 lg:px-8">
            <div class="mb-3 flex justify-between rounded-lg bg-secondary p-4 text-white shadow-lg">
                ...
                <h2>Tambah Data Kondisi Tempat Tinggal Masyarakat</h2>
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <form class="mx-auto max-w-full" action="{{ route('admin.living.conditional.store') }}" method="POST"
                        ...
                        <div class="grid w-full grid-cols-3 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('atap_genteng') }}" placeholder="0" required />
                                @error('atap_genteng')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    id="atap_seng" name="atap_seng" type="number" value="{{ old('atap_seng') }}"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('atap_rumbia') }}" placeholder="0" required />
                                @error('atap_rumbia')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="grid w-full grid-cols-3 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('dinding_semen') }}" placeholder="0" required />
                                @error('dinding_semen')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('dinding_kayu') }}" placeholder="0" required />
                                @error('dinding_kayu')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('dinding_lainnya') }}" placeholder="0" required />
                        ...
                        <div class="grid w-full grid-cols-3 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('lantai_semen') }}" placeholder="0" required />
                                @error('lantai_semen')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('lantai_keramik') }}" placeholder="0" required />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('lantai_lainnya') }}" placeholder="0" required />
