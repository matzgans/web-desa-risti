    ...
    <div class="pt-4">
        <div class="max-w-full px-3 sm:px-6 lg:px-8">
            <div class="mb-3 flex justify-between rounded-lg bg-secondary p-4 text-white shadow-lg">
                ...
                <h2>Data Kondisi Tempat Tinggal</h2>
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <div class="mb-2 flex flex-col items-center sm:flex-row">
                    <form class="mb-2 w-full sm:mb-0 sm:me-2" action="{{ route('admin.living.conditional.index') }}"
                        method="GET">
                    ...
                    <a class="mb-2 w-full rounded-lg bg-green-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 sm:mb-0 sm:me-2 sm:w-auto"
                        href="{{ route('admin.living.conditional.create') }}">
                    ...
                    {{-- <a class="mb-2 w-full rounded-lg bg-red-500 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-red-300 focus:outline-none focus:ring-4 focus:ring-red-300 dark:bg-red-300 dark:hover:bg-red-500 dark:focus:ring-red-300 sm:mb-0 sm:me-2 sm:w-auto"
                        href="{{ route('admin.export.living_conditions') }}">
                ...
                <div class="relative overflow-x-auto">
                        ...
                        <thead class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th class="border border-gray-300 px-6 py-3 text-center" scope="col"
                                    colspan="9">Kondisi Tempat Tinggal (Rumah)</th>

                                <th class="border border-gray-300 px-6 py-3" scope="col" rowspan="3">Aksi</th>
                            </tr>
                            <tr>
                                <th class="border border-gray-300 px-6 py-3 text-center" colspan="3">Atap</th>
                                <th class="border border-gray-300 px-6 py-3 text-center" colspan="3">Dinding</th>
                                <th class="border border-gray-300 px-6 py-3 text-center" colspan="3">Lantai
                                </th>
                            </tr>
                            <tr>
                                <th class="border border-gray-300 px-6 py-3" colspan="1">Genteng</th>
                                <th class="border border-gray-300 px-6 py-3" colspan="1">Seng</th>
                                <th class="border border-gray-300 px-6 py-3" colspan="1">Rumbia</th>
                                <th class="border border-gray-300 px-6 py-3" colspan="1">Semen</th>
                                <th class="border border-gray-300 px-6 py-3" colspan="1">Kayu</th>
                                <th class="border border-gray-300 px-6 py-3" colspan="1">Lainnya</th>
                                <th class="border border-gray-300 px-6 py-3" colspan="1">Semen</th>
                                <th class="border border-gray-300 px-6 py-3" colspan="1">Keramik</th>
                                <th class="border border-gray-300 px-6 py-3" colspan="1">Lainnya</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($living_conditions as $living_condition)
                                <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                                    <th class="whitespace-nowrap border border-gray-300 px-6 py-4 font-medium text-gray-900 dark:text-white"
                                        scope="row">
                                        {{ ($living_conditions->currentPage() - 1) * $living_conditions->perPage() + $loop->iteration }}
                                    </th>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $living_condition->village_name }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $living_condition->atap_genteng }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $living_condition->atap_seng }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $living_condition->atap_rumbia }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $living_condition->dinding_semen }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $living_condition->dinding_kayu }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $living_condition->dinding_lainnya }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $living_condition->lantai_semen }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $living_condition->lantai_keramik }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $living_condition->lantai_lainnya }}
                                    </td>

                                    <td class="border border-gray-300 px-6 py-4">
                                        <div class="flex items-center">
                                            <a
                                                href="{{ route('admin.living.conditional.edit', ['conditional' => $living_condition->id]) }}">
                                            ...
                                            <a href="javascript:void(0);"
                                                onclick="confirmDelete('{{ $living_condition->id }}', '{{ addslashes($living_condition->village_name) }}')">
                                            ...
                                            <form id="delete-form-{{ $living_condition->id }}" style="display: none;"
                                                action="{{ route('admin.living.conditional.destroy', ['conditional' => $living_condition->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                    ...
                    {{ $living_conditions->links('vendor.pagination.tailwind') }}
                </div>
            </div>
        </div>
