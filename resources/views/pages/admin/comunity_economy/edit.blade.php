    ...
    <div class="pt-4">
        <div class="max-w-7xl px-0 sm:px-6 lg:px-8">
            <div class="mb-3 flex justify-between rounded-lg bg-secondary p-4 text-white shadow-lg">
                ...
                <h2>Edit Data Usaha Ekonomi Masyarakat</h2>
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <form class="mx-auto max-w-full"
                    action="{{ route('admin.comunity.economy.update', ['economy' => $comunity_economy->id]) }}"
                            ...
                            <select
                                ...
                                @foreach ($villages as $village)
                                    <option value="{{ $village->id }}"
                                        {{ old('village_id', $comunity_economy->village_id) == $village->id ? 'selected' : '' }}>
                    ...
                    <div class="grid w-full grid-cols-3 gap-4">
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('pertokoan_owner', $comunity_economy->pertokoan_count) }}"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('pertokoan_owner', $comunity_economy->pertokoan_owner) }}"
                                    placeholder="0" required />
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('perkiosan_count', $comunity_economy->perkiosan_count) }}"
                                    placeholder="0" required />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('perkiosan_owner', $comunity_economy->perkiosan_owner) }}"
                                    placeholder="0" required />
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="rm_count" name="rm_count" type="number"
                                    value="{{ old('rm_count', $comunity_economy->rm_count) }}" placeholder="0"
                                    required />
                                @error('rm_count')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input
                                    class="col-span-2 block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="rm_owner" name="rm_owner" type="number"
                                    value="{{ old('rm_owner', $comunity_economy->rm_owner) }}" placeholder="0"
                                    required />
                                @error('rm_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('perbengkelan_count', $comunity_economy->perbengkelan_count) }}"
                                    placeholder="0" required />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('perbengkelan_owner', $comunity_economy->perbengkelan_owner) }}"
                                    placeholder="0" required />
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('mebel_count', $comunity_economy->mebel_count) }}" placeholder="0"
                                    required />
                                @error('mebel_count')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('mebel_owner', $comunity_economy->mebel_owner) }}" placeholder="0"
                                    required />
                                @error('mebel_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('pangkalan_lpg_count', $comunity_economy->pangkalan_lpg_count) }}"
                                    placeholder="0" required />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('pangkalan_lpg_owner', $comunity_economy->pangkalan_lpg_owner) }}"
                                    placeholder="0" required />
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('taylor_count', $comunity_economy->taylor_count) }}"
                                    placeholder="0" required />
                                @error('taylor_count')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('taylor_owner', $comunity_economy->taylor_owner) }}"
                                    placeholder="0" required />
                                @error('taylor_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('lainnya_count', $comunity_economy->lainnya_count) }}"
                                    placeholder="0" required />
                                @error('lainnya_count')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('lainnya_owner', $comunity_economy->lainnya_owner) }}"
                                    placeholder="0" required />
                                @error('lainnya_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
