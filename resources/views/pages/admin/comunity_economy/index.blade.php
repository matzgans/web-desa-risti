    ...
    <div class="pt-4">
        <div class="max-w-full px-3 sm:px-6 lg:px-8">
            <div class="mb-3 flex justify-between rounded-lg bg-secondary p-4 text-white shadow-lg">
                ...
                <h2>Data Usaha Ekonomi Masyarakat</h2>
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <div class="mb-2 flex flex-col items-center sm:flex-row">
                    <form class="mb-2 w-full sm:mb-0 sm:me-2" action="{{ route('admin.comunity.economy.index') }}"
                        method="GET">
                    ...
                    <a class="mb-2 w-full rounded-lg bg-green-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 sm:mb-0 sm:me-2 sm:w-auto"
                        href="{{ route('admin.comunity.economy.create') }}">
                    ...
                    {{-- <a class="mb-2 w-full rounded-lg bg-red-500 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-red-300 focus:outline-none focus:ring-4 focus:ring-red-300 dark:bg-red-300 dark:hover:bg-red-500 dark:focus:ring-red-300 sm:mb-0 sm:me-2 sm:w-auto"
                        href="{{ route('admin.export.comunity_economy') }}">
                ...
                <div class="relative overflow-x-auto">
                    <table
                        ...
                        <thead class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th class="border border-gray-300 px-6 py-3 text-center" scope="col"
                                    colspan="24">Usaha Ekonomi
                                    Masyarakat</th>

                                <th class="border border-gray-300 px-6 py-3" scope="col" rowspan="3">Aksi</th>
                            </tr>
                            <tr>
                                <th class="border border-gray-300 px-6 py-3 text-center" colspan="3">Pertokoan</th>
                                <th class="border border-gray-300 px-6 py-3 text-center" colspan="3">Perkiosan</th>
                                <th class="border border-gray-300 px-6 py-3 text-center" colspan="3">Warung Makan
                                </th>
                                <th class="border border-gray-300 px-6 py-3 text-center" colspan="3">Perbengkelan
                                </th>
                                <th class="border border-gray-300 px-6 py-3 text-center" colspan="3">Mebel Kayu
                                </th>
                                <th class="border border-gray-300 px-6 py-3 text-center" colspan="3">Pangkalan LPG
                                </th>
                                <th class="border border-gray-300 px-6 py-3 text-center" colspan="3">Taylor
                                </th>
                                <th class="border border-gray-300 px-6 py-3 text-center" colspan="3">Lainnya
                                </th>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($comunity_economies as $comunity_economy)
                                <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                                    <th class="whitespace-nowrap border border-gray-300 px-6 py-4 font-medium text-gray-900 dark:text-white"
                                        scope="row">
                                        {{ ($comunity_economies->currentPage() - 1) * $comunity_economies->perPage() + $loop->iteration }}
                                    </th>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $comunity_economy->village_name }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4" colspan="2">
                                        {{ $comunity_economy->pertokoan_count }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $comunity_economy->pertokoan_owner }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4" colspan="2">
                                        {{ $comunity_economy->perkiosan_count }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $comunity_economy->perkiosan_owner }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4" colspan="2">
                                        {{ $comunity_economy->rm_count }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $comunity_economy->rm_owner }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4" colspan="2">
                                        {{ $comunity_economy->perbengkelan_count }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $comunity_economy->perbengkelan_owner }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4" colspan="2">
                                        {{ $comunity_economy->mebel_count }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $comunity_economy->mebel_owner }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4" colspan="2">
                                        {{ $comunity_economy->pangkalan_lpg_count }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $comunity_economy->pangkalan_lpg_owner }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4" colspan="2">
                                        {{ $comunity_economy->taylor_count }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $comunity_economy->taylor_owner }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4" colspan="2">
                                        {{ $comunity_economy->lainnya_count }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $comunity_economy->lainnya_owner }}
                                    </td>

                                    <td class="border border-gray-300 px-6 py-4">
                                        <div class="flex items-center">
                                            <a
                                                href="{{ route('admin.comunity.economy.edit', ['economy' => $comunity_economy->id]) }}">
                                            ...
                                            <a href="javascript:void(0);"
                                                onclick="confirmDelete('{{ $comunity_economy->id }}', '{{ addslashes($comunity_economy->village_name) }}')">
                                            ...
                                            <form id="delete-form-{{ $comunity_economy->id }}" style="display: none;"
                                                action="{{ route('admin.comunity.economy.destroy', ['economy' => $comunity_economy->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                    ...
                    {{ $comunity_economies->links('vendor.pagination.tailwind') }}
                </div>
            </div>
        </div>
