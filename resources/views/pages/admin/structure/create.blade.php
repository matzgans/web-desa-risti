    ...
    <div class="pt-4">
        <div class="max-w-7xl px-0 sm:px-6 lg:px-8">
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <form class="mx-auto max-w-full" action="{{ route('admin.structure.store') }}" method="POST"
                    ...
                    <div class="grid w-full grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                id="staff_name" name="staff_name" type="text" value="{{ old('staff_name') }}"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('staff_description') }}" placeholder="Periode 2024-2029" required />
