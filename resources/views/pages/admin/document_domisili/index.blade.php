    ...
    <div class="pt-4">
        <div class="max-w-full px-3 sm:px-6 lg:px-8">
            <div class="mb-3 flex justify-between rounded-lg bg-secondary p-4 text-white shadow-lg">
                <h2>Data Surat Keterangan Domisili</h2>
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <div class="mb-2 flex flex-col items-center sm:flex-row">
                    <form class="mb-2 w-full sm:mb-0 sm:me-2" action="{{ route('admin.document.domisili.index') }}"
                        method="GET">
                    ...
                    <table
                        ...
                        <thead class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th class="border border-gray-300 px-6 py-3" scope="col">gender</th>
                                ...
                                <th class="border border-gray-300 px-6 py-3" scope="col">Alamat Ktp</th>
                        ...
                        <tbody>
                            @forelse ($documents as $document)
                                <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                                    ...
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['ktp_address'] }}</td>
                                    ...
                                    <td class="border border-gray-300 px-6 py-4">
                                        <div class="flex items-center">
                                            <a href="{{ route('admin.document.domisili.edit', $document['id']) }}">
                                            ...
                                            <form id="delete-form-{{ $document['id'] }}" style="display: none;"
                                                action="{{ route('admin.document.domisili.destroy', ['domisili' => $document['id']]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                            ...
                                            <form id="print-form-{{ $document['id'] }}" style="display: none;"
                                                action="{{ route('admin.document.domisili.print', ['id' => $document['id']]) }}"
                                                method="GET">
                                                @csrf
                                                @method('GET')
                                            </form>
