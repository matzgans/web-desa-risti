    ...
    <div class="pt-4">
        <div class="max-w-7xl px-0 sm:px-6 lg:px-8">
            <div class="mb-3 flex justify-between rounded-lg bg-secondary p-4 text-white shadow-lg">
                ...
                <h2>Edit Data Perangkat Komunikasi</h2>
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <form class="mx-auto max-w-full"
                    action="{{ route('admin.comunication_device.update', $comunication_device->id) }}" method="POST"
                            ...
                            <select
                                ...
                                @foreach ($villages as $village)
                                    <option value="{{ $village->id }}"
                                        {{ old('village_id', $comunication_device->village_id) == $village->id ? 'selected' : '' }}>
                    ...
                    <div class="grid w-full grid-cols-2 gap-4">
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="tv_count" name="tv_count" type="number"
                                    value="{{ old('tv_count', $comunication_device) }}" placeholder="0" required />
                                @error('tv_count')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    id="tv_owner" name="tv_owner" type="number"
                                    value="{{ old('tv_owner', $comunication_device) }}" placeholder="0" required />
                                @error('tv_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('parabola_count', $comunication_device) }}" placeholder="0"
                                    required />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('parabola_owner', $comunication_device) }}" placeholder="0"
                                    required />
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="hp_count" name="hp_count" type="number"
                                    value="{{ old('hp_count', $comunication_device) }}" placeholder="0" required />
                                @error('hp_count')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input
                                    class="col-span-2 block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="hp_owner" name="hp_owner" type="number"
                                    value="{{ old('hp_owner', $comunication_device) }}" placeholder="0" required />
                                @error('hp_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('radio_count', $comunication_device) }}" placeholder="0"
                                    required />
                                @error('radio_count')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('radio_owner', $comunication_device) }}" placeholder="0"
                                    required />
                                @error('radio_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
