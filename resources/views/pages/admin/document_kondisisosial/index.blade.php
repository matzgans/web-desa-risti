    ...
    <div class="pt-4">
        <div class="max-w-full px-3 sm:px-6 lg:px-8">
            <div class="mb-3 flex justify-between rounded-lg bg-secondary p-4 text-white shadow-lg">
                <h2>Data Surat Keterangan Kondisi Sosial Orang Tua</h2>
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <div class="mb-2 flex flex-col items-center sm:flex-row">
                    <form class="mb-2 w-full sm:mb-0 sm:me-2"
                        action="{{ route('admin.document.kondisi_sosial.index') }}" method="GET">
                    ...
                    <table
                        ...
                        <thead class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th class="border border-gray-300 px-6 py-3" scope="col">Nama Orang Tua / Wali</th>
                                ...
                                <th class="border border-gray-300 px-6 py-3" scope="col">Nama Anak</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Prodi</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Nomor HP / Email</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Alasan Penurunan</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Pendapatan Sebelum</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Pendapatan Setelah</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Penurunan Pendapatan</th>
                                <th class="border border-gray-300 px-6 py-3" scope="col">Jumlah Tanggungan</th>
                        ...
                        <tbody>
                            @forelse ($documents as $document)
                                <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                                    ...
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['kids_name'] }}</td>
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['prodi'] }}</td>
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['contact'] }}</td>
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['reason'] }}</td>
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['pendapatan_sebelum'] }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['pendapatan_setelah'] }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $document['penurunan_pendapatan'] }}</td>
                                    <td class="border border-gray-300 px-6 py-4">{{ $document['tanggungan'] }}</td>
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                    ...
                                    <td class="border border-gray-300 px-6 py-4">
                                        <div class="flex items-center">
                                            <a
                                                href="{{ route('admin.document.kondisi_sosial.edit', $document['id']) }}">
                                            ...
                                            action="{{ route('admin.document.kondisi_sosial.destroy', ['kondisi_sosial' => $document['id']]) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                        ...
                                        <form id="print-form-{{ $document['id'] }}" style="display: none;"
                                            action="{{ route('admin.document.kondisi_sosial.print', ['id' => $document['id']]) }}"
                                            method="GET"
                                            target="blank">
                                            @csrf
                                            @method('GET')
