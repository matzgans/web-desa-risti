    ...
    <div class="pt-4">
        <div class="max-w-7xl px-0 sm:px-6 lg:px-8">
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <form class="mx-auto max-w-full" action="{{ route('admin.transportation.store') }}" method="POST"
                    ...
                    <div class="grid w-full grid-cols-3 gap-4">
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="car_count" name="car_count" type="number" value="{{ old('car_count') }}"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="car_owner" name="car_owner" type="number" value="{{ old('car_owner') }}"
                                    placeholder="0" required />
                                @error('car_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('motorcycle_count') }}" placeholder="0" required />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('motorcycle_owner') }}" placeholder="0" required />
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('bentor_count') }}" placeholder="0" required />
                                @error('bentor_count')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('bentor_owner') }}" placeholder="0" required />
                                @error('bentor_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
