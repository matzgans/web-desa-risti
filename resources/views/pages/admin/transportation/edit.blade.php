    ...
    <div class="pt-4">
        <div class="max-w-7xl px-0 sm:px-6 lg:px-8">
            <div class="mb-3 flex justify-between rounded-lg bg-secondary p-4 text-white shadow-lg">
                ...
                <a class="flex items-center hover:underline" href="{{ route('admin.transportation.index') }}">
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <form class="mx-auto max-w-full"
                    action="{{ route('admin.transportation.update', ['transportation' => $transportation->id]) }}"
                            ...
                            <select
                                ...
                                @foreach ($villages as $village)
                                    <option value="{{ $village->id }}"
                                        {{ old('village_id', $transportation->village_id) == $village->id ? 'selected' : '' }}>
                    ...
                    <div class="grid w-full grid-cols-3 gap-4">
                        <div class="grid w-full grid-cols-2 gap-2">
                            <label
                                class="col-span-2 block text-sm font-medium text-gray-900 dark:text-white">Mobil</label>
                            <div>
                                <label class="mb-2 block text-sm font-medium text-primary dark:text-white"
                                    for="car_count">Jumlah</label>
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="car_count" name="car_count" type="number"
                                    value="{{ old('car_count', $transportation->car_count) }}" placeholder="0"
                                    required />
                                @error('car_count')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="car_owner" name="car_owner" type="number"
                                    value="{{ old('car_owner', $transportation->car_owner) }}" placeholder="0"
                                    required />
                                @error('car_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            <label
                                class="col-span-2 block text-sm font-medium text-gray-900 dark:text-white">Motor</label>
                            <div>
                                <label class="mb-2 block text-sm font-medium text-primary dark:text-white"
                                    for="motorcycle_count">Jumlah</label>
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="motorcycle_count" name="motorcycle_count" type="number"
                                    value="{{ old('motorcycle_owner', $transportation->motorcycle_count) }}"
                            ...
                            <div>
                                <label class="mb-2 block text-sm font-medium text-primary dark:text-white"
                                    for="motorcycle_owner">Pemilik</label>
                                <input
                                    class="col-span-2 block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="motorcycle_owner" name="motorcycle_owner" type="number"
                                    value="{{ old('motorcycle_owner', $transportation->motorcycle_owner) }}"
                                    placeholder="0" required />
                                @error('motorcycle_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        <div class="grid w-full grid-cols-2 gap-2">
                            <label
                                class="col-span-2 block text-sm font-medium text-gray-900 dark:text-white">Bentor</label>
                            <div>
                                <label class="mb-2 block text-sm font-medium text-primary dark:text-white"
                                    for="bentor_count">Jumlah</label>
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="bentor_count" name="bentor_count" type="number"
                                    value="{{ old('bentor_count', $transportation->bentor_count) }}" placeholder="0"
                                    required />
                                @error('bentor_count')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                <label class="mb-2 block text-sm font-medium text-primary dark:text-white"
                                    for="bentor_owner">Pemilik</label>
                                <input
                                    class="col-span-2 block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="bentor_owner" name="bentor_owner" type="number"
                                    value="{{ old('bentor_owner', $transportation->bentor_owner) }}" placeholder="0"
                                    required />
                                @error('bentor_owner')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
