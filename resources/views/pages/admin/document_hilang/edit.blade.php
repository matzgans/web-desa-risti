    ...
    <div class="pt-4">
        <div class="max-w-full px-3 sm:px-6 lg:px-8">
            <div class="mb-3 flex justify-between rounded-lg bg-secondary p-4 text-white shadow-lg">
                <h2>Edit Data Surat Hilang</h2>
                <a class="flex items-center hover:underline" href="{{ route('admin.document.hilang.index') }}">
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                <form method="POST" action="{{ route('admin.document.hilang.update', ['hilang' => $id]) }}">
                    @csrf
                    @method('PUT')
                    <div class="hidden">
                        ...
                        <input
                            ...
                            id="type" name="type" type="text" value="ket_hilang" placeholder="" required />
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"
                            for="document_name">Barang Yang Hilang</label>
                        <input
                            class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                            id="document_name" name="document_name" type="text" value="{{ $data['document_name'] }}"
                            placeholder="Dompet, KTP" />
                    </div>
