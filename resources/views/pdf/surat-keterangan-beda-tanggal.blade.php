...
<body>
    <div class="container">
        ...
        <hr>
        <div class="content">
            <h3>SURAT KETERANGAN BEDA TANGGAL LAHIR</h3>
            <p>NOMOR : {{ $no_surat }}</p>
            ...
            <div class="text-akhir" style="text-indent:10%" style="margin-top: 70px">Dengan ini memberikan keterangan
                kepada atas nama {{ $name }} yang tercantum pada Kartu Tanda Penduduk ( KTP) dan Dengan No NIK
                {{ $NIK }} dan Nama {{ $name }} pada {{ $wrong_document }} adalah orang yang sama dan
                tanggal lahir
                sebenarnya adalah {{ $birth }}
            </div>
            <br>
