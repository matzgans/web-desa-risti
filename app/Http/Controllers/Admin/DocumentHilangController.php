...
class DocumentHilangController extends Controller
{
    public function index(Request $request)
    {
        $search = $request->input('search');
        $query = Document::where('type', 'ket_hilang');
        ...
        return view("pages.admin.document_hilang.index", compact('documents'));
    }
    ...
    public function edit($id)
    {
        ...
        return view("pages.admin.document_hilang.edit", compact("data", "id", "no_surat"));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()
                ->route("admin.document.hilang.index")
    ...
    public function print($id)
    {
        ...
        if ($document->no_surat) {
            ...
            $pdf = Pdf::loadView('pdf.surat-keterangan-hilang', $data);
            $fileName = 'surat_keterangan_hilang_' . htmlspecialchars($data['name']) . '.pdf';
